...
@OnlyIn(Dist.CLIENT)
public class MasterElevatorRenderer extends EntityRenderer<MasterElevatorEntity> {
    public MasterElevatorRenderer(EntityRendererManager renderManagerIn) {
    ...
    @Override
    public ResourceLocation getEntityTexture(MasterElevatorEntity entity) {
        return null;
    }
}
